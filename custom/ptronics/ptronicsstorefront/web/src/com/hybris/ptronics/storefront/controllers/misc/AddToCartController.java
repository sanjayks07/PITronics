 ...
 */
package com.hybris.ptronics.storefront.controllers.misc;
...
public class AddToCartController extends AbstractController
{
	...
	private static final String SHOWN_PRODUCT_COUNT = "ptronicsstorefront.storefront.minicart.shownProductCount";
	...
	public final String addQuickOrderToCart(@RequestBody final AddToCartOrderForm form, final Model model)
	{
		...
		final int maxQuickOrderEntries = Config.getInt("ptronicsstorefront.quick.order.rows.max", 25);
