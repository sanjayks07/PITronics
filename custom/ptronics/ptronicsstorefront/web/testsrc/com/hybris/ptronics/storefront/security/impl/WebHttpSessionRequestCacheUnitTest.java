...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ptronicsstorefront/electronics/en",
						"https://electronics.local:9002/ptronicsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ptronicsstorefront/electronics/en",
						"https://electronics.local:9002/ptronicsstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ptronicsstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/ptronicsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ptronicsstorefront/electronics/en",
						"https://electronics.local:9002/ptronicsstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ptronicsstorefront",
						"https://electronics.local:9002/ptronicsstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ptronicsstorefront",
						"https://electronics.local:9002/ptronicsstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/ptronicsstorefront/electronics/en",
						"https://electronics.local:9002/ptronicsstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
