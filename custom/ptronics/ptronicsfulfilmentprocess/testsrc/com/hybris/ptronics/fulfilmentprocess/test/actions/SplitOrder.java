 ...
 */
package com.hybris.ptronics.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(PtronicsFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(PtronicsFulfilmentProcessConstants.PARENT_PROCESS);
