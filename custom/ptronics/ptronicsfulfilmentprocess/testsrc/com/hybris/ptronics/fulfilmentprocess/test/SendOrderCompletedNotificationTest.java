...
import com.hybris.ptronics.fulfilmentprocess.actions.order.SendOrderCompletedNotificationAction;
...
public class SendOrderCompletedNotificationTest
{
	...
	/**
	 * Test method for
	 * {@link com.hybris.ptronics.fulfilmentprocess.actions.order.SendOrderCompletedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
