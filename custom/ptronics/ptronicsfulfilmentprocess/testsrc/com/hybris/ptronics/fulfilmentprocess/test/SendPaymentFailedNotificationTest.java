...
import com.hybris.ptronics.fulfilmentprocess.actions.order.SendPaymentFailedNotificationAction;
...
public class SendPaymentFailedNotificationTest
{
	...
	/**
	 * Test method for
	 * {@link com.hybris.ptronics.fulfilmentprocess.actions.order.SendPaymentFailedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
