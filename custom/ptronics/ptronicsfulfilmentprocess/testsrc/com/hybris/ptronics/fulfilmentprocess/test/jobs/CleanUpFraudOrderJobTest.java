 ...
 */
package com.hybris.ptronics.fulfilmentprocess.test.jobs;
...
import com.hybris.ptronics.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = PtronicsFulfilmentProcessConstants.ORDER_PROCESS_NAME;
