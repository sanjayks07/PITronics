 ...
 */
package com.hybris.ptronics.test.setup;
...
import com.hybris.ptronics.test.constants.PtronicsTestConstants;
import com.hybris.ptronics.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = PtronicsTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/ptronicstest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/ptronicstest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/ptronicstest/import/cstickets.impex");
			...
			importImpexFile(context, "/ptronicstest/import/csquotes.impex");
		}
	}
}
